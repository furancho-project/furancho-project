...
const { furanchos, auth, comment, users, favourite, misc } = require("../controllers");
...
router.post("/furanchos/:id/delete", secure.isAdmin, furanchos.delete);

router.get("/aboutus", misc.aboutUs);
